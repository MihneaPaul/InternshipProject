...
create ttCustomer.
assign 
    ttCustomer.CustNum = 98769
    ttCustomer.Name    = "Dorel the Duck".

find ttCustomer where ttCustomer.CustNum = 7.
 ttCustomer.Name = "Nelutzu".
 
/*create ttOrder*/
/*assign        */
/*              */
find first ttCustomer where ttCustomer.CustNum = 5.
find first ttOrder  of ttCustomer.
MESSAGE ttOrder.custnum
VIEW-AS ALERT-BOX.
assign ttOrder.ShipDate = 11/11/9999.
...
/*for each btOrder no-lock:                          */
/*    display btOrder.OrderNum                       */
/*    btOrder.ShipDate                               */
/*    with frame btOrderFrame 1 col title "BT Order".*/
/*end.                                               */
/*                                                   */
